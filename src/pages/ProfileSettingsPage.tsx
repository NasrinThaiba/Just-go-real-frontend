...
export default function ProfileSettingsPage() {
  ...
  return (
    <main className="h-screen w-screen overflow-hidden bg-white text-[#18212f]">
      <section className="grid h-screen w-screen grid-cols-1 lg:grid-cols-[720px_minmax(0,1fr)]">

<section className="relative z-10 flex h-screen w-full items-start justify-center bg-white px-6 pb-4 pt-10 sm:px-10 lg:px-12">
  <div className="w-full max-w-[520px] pt-0">
    <div className="mb-5">
      <img
        src={logo}
        alt="Just Go Real"
      ...
      <div className="mt-5 inline-flex items-center gap-2 rounded-full bg-orange-50 px-4 py-1.5 text-[12px] font-black uppercase tracking-wide text-[#ef4b2b] ring-1 ring-orange-100">
        <ShieldCheck className="h-3.5 w-3.5" />
        Profile Setup
      </div>

      <h1 className="mt-4 text-4xl font-black tracking-tight text-[#18212f]">
        Complete profile
      </h1>
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <select
            ...
            className="h-12 w-full appearance-none rounded-2xl border border-slate-200 bg-white pl-11 pr-4 text-sm font-bold text-slate-700 shadow-sm outline-none focus:border-[#ef4b2b] focus:ring-4 focus:ring-orange-100"
          >
      ...
      <button
        ...
        className="group flex h-[52px] w-full items-center justify-center gap-2 rounded-2xl bg-foreground text-md text-white shadow-orange-100 transition hover:bg-orange-700"
      >
        Save & Continue
        ...
        <section className="relative hidden h-screen overflow-hidden bg-[#071f3d] lg:block">
          ...
          <div className="absolute inset-0 opacity-[0.08]">
            <div className="grid h-full grid-cols-6 gap-3 p-6">
          ...
          <div className="relative z-10 flex h-screen flex-col justify-between p-8 xl:p-10">
            <div className="flex items-center justify-between">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-xs font-bold text-white ring-1 ring-white/15 backdrop-blur">
                <Newspaper className="h-4 w-4 text-orange-200" />
                Just Go Real
              </div>

              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-xs font-bold text-white/80 ring-1 ring-white/15 backdrop-blur">
            ...
            <div className="max-w-3xl">
              <p className="mb-4 inline-flex items-center gap-2 rounded-full bg-[#ef4b2b] px-4 py-2 text-xs font-black uppercase tracking-wide text-white">
                <UserRound className="h-4 w-4" />
                First Time Setup
              </p>

              <h2 className="text-5xl font-black leading-[1.02] tracking-tight text-white xl:text-6xl">
                Build your
                <br />
                local news
                <br />
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-white/70 xl:text-base">
            ...
            <div className="grid max-w-4xl grid-cols-3 gap-4">
              <div className="rounded-[1.5rem] bg-white/10 p-4 ring-1 ring-white/10 backdrop-blur">
                <UserRound className="mb-3 h-6 w-6 text-orange-200" />
                <p className="text-base font-black text-white">Profile</p>
              ...
              <div className="rounded-[1.5rem] bg-white/10 p-4 ring-1 ring-white/10 backdrop-blur">
                <UsersRound className="mb-3 h-6 w-6 text-orange-200" />
                <p className="text-base font-black text-white">Role</p>
                <p className="mt-1 text-xs leading-5 text-white/55">
              ...
              <div className="rounded-[1.5rem] bg-white/10 p-4 ring-1 ring-white/10 backdrop-blur">
                <BellRing className="mb-3 h-6 w-6 text-orange-200" />
                <p className="text-base font-black text-white">Alerts</p>
                <p className="mt-1 text-xs leading-5 text-white/55">
